...
public class TransactionRepositoryImpl implements TransactionRepository {
    ...
    private static String SQL_FIND_ALL = "SELECT TRANSACTION_ID, CATEGORY_ID, USER_ID, AMOUNT, NOTE, TRANSACTION_DATE FROM ET_TRANSACTIONS WHERE USER_ID = ? AND CATEGORY_ID = ?";
    ...
    public void removeById(Integer userId, Integer categoryId, Integer transactionId)
        ...
        if(count == 0)
        throw new EtResourceNotFoundException("Trandaction not found");
